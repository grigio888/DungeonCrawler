import { createMonsterSpec } from '$lib/content/monsters/factory.js';
import { estimateDamage as computeDamage } from '$lib/game/combat/index.js';
import SkillFactory from '$lib/content/skills/factory.js';

/**
 * Owns a single monster's runtime spec: identity, vitals, and combat stats.
 */
export default class BaseMonster {
	/** @param {import('$lib/content/monsters/factory.js').MonsterSpec | Record<string, unknown>} [input] */
	constructor(input = {}) {
