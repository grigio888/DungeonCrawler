<script>
	...
	import { createCharacterSpec } from '$lib/characters';
...
<main class="min-h-screen bg-zinc-950 text-zinc-100">
	<div class="mx-auto max-w-6xl px-4 py-8">
		<header class="mb-8 border-b border-zinc-800 pb-6">
			<p class="text-sm font-medium uppercase tracking-wide text-emerald-400/90">Debug</p>
		...
		<div class="grid items-start gap-8 lg:grid-cols-[minmax(17rem,280px)_minmax(0,1fr)]">
			...
			>
				...
				>
					<h2 class="text-sm font-medium uppercase tracking-wide text-emerald-400/90">
						Configure
					</h2>
					...
					<dl class="mt-4 space-y-2 border-t border-zinc-800 pt-4 text-sm">
						<div class="flex justify-between gap-2">
							<dt class="text-zinc-400">Base ({BASE_CHARACTER_STAT_VALUE}×{ALLOCATABLE_SCALES.length})</dt>
			...
			<div class="min-w-0 space-y-6">
				...
				<section class="rounded-xl border border-zinc-800 bg-zinc-900/60 p-5">
					...
					<dl class="mt-4 grid gap-3 sm:grid-cols-2">
						...
						<div>
							<dt class="text-xs uppercase text-zinc-500">Class</dt>
						...
						<div>
							<dt class="text-xs uppercase text-zinc-500">Tier</dt>
				...
				<section class="rounded-xl border border-zinc-800 bg-zinc-900/60 p-5">
					...
					<dl class="mt-4 grid gap-3 sm:grid-cols-2">
						...
						<div>
							<dt class="text-xs uppercase text-zinc-500">SP</dt>
						...
						<table class="w-full text-left text-sm">
							<thead class="border-b border-zinc-700 text-zinc-500">
								<tr>
									...
									<th class="pb-2 pr-4 font-medium text-right">HP</th>
									<th class="pb-2 font-medium text-right">SP</th>
								</tr>
							</thead>
