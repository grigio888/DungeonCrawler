...
/**
 * @param {InstanceType<typeof import('$lib/content/items/equipments/factory.js').default>} equipment
 * @param {import('$lib/content/items/equipments/types.js').EquipmentDefinition} definition
 * @param {string} [label]
 */
