...
/**
 * @param {InstanceType<typeof import('$lib/content/items/weapons/factory.js').default>} weapon
 * @param {import('$lib/content/items/weapons/types.js').WeaponDefinition} definition
 * @param {string} [label]
 */
