...
import { ALLOCATABLE_SCALES, getTotalStatPoints } from '$lib/game/progression';
...
/**
 * @param {import('$lib/content/monsters/factory.js').MonsterSpec} spec
 * @param {import('$lib/content/monsters/registry.js').default[string]} definition
 * @param {number} level
 * @param {string} [label]
 */
