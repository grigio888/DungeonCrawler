...
} from '$lib/sprites/monsterSprite.js';

describe('sprites/monsterSprite', () => {
	const glob = {
		'/project/src/lib/monsters/0001_jelly/sprites/idle.png': '/assets/jelly-idle.png',
		'/project/src/lib/monsters/0002_fabre/sprites/idle.png': '/assets/fabre-idle.png',
		'/project/src/lib/monsters/0002_fabre/sprites/walk.png': '/assets/fabre-walk.png'
	};
	...
	it('documents the expected on-disk path', () => {
		expect(getMonsterSpritePath('0002_fabre')).toBe('src/lib/monsters/0002_fabre/sprites/idle.png');
	});
